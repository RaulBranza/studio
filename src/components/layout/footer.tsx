      ...
      <div className="container py-12 px-4 md:px-6">
        <div className="grid gap-8 md:grid-cols-3">
          <div className="space-y-2">
            ...
            <p className="text-sm">Classic Cuts, Modern Style.</p>
            <p className="text-xs text-muted-foreground">&copy; {new Date().getFullYear()} ClipCut Barbershop. All rights reserved.</p>
          </div>
          <div className="grid gap-4">
            <h4 className="font-semibold font-headline">Contact Us</h4>
            <div className="text-sm space-y-2">
              <p>123 Barber Lane, Styleburg, ST 12345</p>
              <p>
          ...
          <div className="grid gap-4">
            <h4 className="font-semibold font-headline">Opening Hours</h4>
